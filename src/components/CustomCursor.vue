...
.cursor(:class="classes")
  ...
  .social-picto.telegram
    inline-svg(:src="svgTelegram")
  .social-picto.mailto
...
$cursor-color = $theme-color-green
$cursor-size = 60px
$visor-size = 0px
...
.cursor
  ...
  .social-picto
    ...
    &.telegram
      margin-top (- $social-picto-size*$telegram-picto-ratio-wh/2)
    &.mailto
  ...
  &:not(.hidden)
    ...
    &:not(.twitter-cursor):not(.telegram-cursor):not(.mailto-cursor):not(.scroll-cursor)&:not(.fifteen-cursor)
...
import svgTelegram from '@/assets/images/telegram-logo.svg';
  ...
  data() {
    ...
    return {
      ...
      clickableLogic: [
        ...
        {
          selector: 'a[href^=http]:not(.twitter):not(.telegram):not(.fifteen)',
            ...
            click: function (e) {
              ...
              setTimeout(function () {
                window.location.href =
                  'mailto:' + rot13('team@memenatis.xyz');
              }, 500);
              return false;
            },
          },
